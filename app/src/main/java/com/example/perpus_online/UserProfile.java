...
public class UserProfile extends AppCompatActivity {
    ...
    String _NAME, _EMAIL, _USERNAME, _PASSWORD, _IMAGE;
    ...
    private void uploadPicture(){
        ...
        Log.d("HASILID", "key : "+ _IMAGE);
        StorageReference riversRef = storageReference.child("images/"+_IMAGE);
    ...
    private void showAllUserData(){
        ...
        StorageReference mStorageReference = FirebaseStorage.getInstance().getReference().child("images/"+_IMAGE);

        try {
            final File localFile = File.createTempFile(_IMAGE, "");
