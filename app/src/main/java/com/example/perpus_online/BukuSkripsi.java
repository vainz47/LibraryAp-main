...
public class BukuSkripsi {
    ...
    public BukuSkripsi(String kode, String judul, String pengarang, String jurnal,  String halaman, String tahunterbit, String abstrak, String status, String imageKey){
        this.kode = kode;
        this.judul = judul;
        this.pengarang = pengarang;
        this.jurnal = jurnal;
